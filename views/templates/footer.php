<footer class="footer">
     <div class="footer__grid">
        <div class="footer__contenido">
            ...
            <p class="footer__texto">
                DevWebCamp es una conferencia para desarrolladores de todas los niveles, se lleva a cabo en forma presencial y en linea.
            </p>
        </div>
    ...
    <a class="menu-redes__enlace" rel="noopener noreferrer" target="_blank" href="https://github.com/codigoconjuan">
     ...
     <p class="footer__copyright">
        DevWebCamp
        <span class="footer__copyright__regular">
